...
<div class=" {showPeopleListValue!=0 ? "w-5/6": "w-full"}  transition-all duration-200 ease-linear bg-[#36393f] flex flex-col">
                <!-- all messaging -->
                ...
                <!-- write message -->
                <div class=" flex-none min-w-full py-2 px-1 flex flex-row h-14 place-items-center ">
                    <!-- all -->
                    ...
                    <input type="text" placeholder="Type here" class="input h-10 min-w-fit grow rounded-2xl transition-all duration-250 ease-linear " on:focus="{()=>{writeFocus=true}}" on:blur="{()=>{writeFocus = false}}">
