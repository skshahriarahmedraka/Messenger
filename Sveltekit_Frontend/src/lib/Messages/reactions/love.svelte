...
class={$$props.class}
	...
	><title /><desc /><defs
		><radialGradient
			...
			id="radialGradient-1"
			r="87.8884669%"
			><stop offset="0%" stop-color="#F25674" /><stop
				offset="100%"
				stop-color="#D82D4E"
			/></radialGradient
		></defs
	><g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1"
		><g id="Artboard" transform="translate(-1565.000000, -821.000000)"
			><g id="Group-9" transform="translate(1565.000000, 821.000000)"
				><circle cx="259.5" cy="259.5" fill="url(#radialGradient-1)" id="Oval" r="259.5" /><path
